...
var https__default = /*#__PURE__*/_interopDefaultLegacy(https$4);
...
const timer = (request) => {
    ...
    const handleError = (origin) => {
        origin.once(require$$0$1.errorMonitor, () => {
...
var eos = endOfStream;
var fs$1 = require$$2__default["default"]; // we only need fs to get the ReadStream and WriteStream prototypes
...
const {PassThrough: PassThroughStream$1} = require$$0__default["default"];
...
const {constants: BufferConstants$1} = require$$0__default$1["default"];
const pump = pump_1;
...
const Readable$1 = require$$0__default["default"].Readable;
...
const urlLib = require$$0__default$3["default"];
...
const zlib = require$$1__default["default"];
...
var decompressResponse$1 = decompressResponse;
...
const {promisify: promisify$1} = require$$1__default$1["default"];
...
var CacheableLookup$1 = source$1.exports;
...
const tls$3 = require$$0__default$5["default"];
...
const tls$2 = require$$0__default$5["default"];
...
const {isIP} = require$$0__default$6["default"];
...
const http$3 = require$$1__default$3["default"];
const https$3 = require$$2__default$2["default"];
...
auto$1.exports = async (input, options, callback) => {
	...
	options._defaultAgent = isHttps ? https$3.globalAgent : http$3.globalAgent;
	...
	if (isHttps) {
		...
		if (agent === undefined) {
			agent = isHttp2 ? globalAgent$3 : https$3.globalAgent;
		}
		...
		if (socket) {
			if (agent === false) {
				...
				const defaultCreateConnection = (isHttp2 ? Agent$2 : https$3.Agent).prototype.createConnection;
...
const tls$1 = require$$0__default$5["default"];
...
const https$2 = require$$2__default$2["default"];
	...
	(async () => {
		try {
			...
			stream.once('response', headers => {
				...
				const encrypted = self instanceof https$2.Agent;
...
class HttpsOverHttp2$1 extends https$2.Agent {
	constructor(options) {
		super(options);
...
const https$1 = require$$2__default$2["default"];
...
class Http2OverHttp$1 extends Http2OverHttpX {
	async _getProxyStream(authority) {
		...
		const network = url.protocol === 'https:' ? https$1 : http$1;
...
const [major, minor] = process__default["default"].versions.node.split('.').map(v => Number(v));
function validateSearchParameters(searchParameters) {
    // eslint-disable-next-line guard-for-in
    for (const key in searchParameters) {
        const value = searchParameters[key];
        dist.exports.assert.any([is.string, is.number, is.boolean, is.null_, is.undefined], value);
    }
}
...
const getGlobalDnsCache = () => {
    ...
    globalDnsCache = new CacheableLookup$1();
    return globalDnsCache;
};
const defaultInternals = {
    ...
    pagination: {
        ...
        paginate({ response }) {
            ...
            if (next) {
                return {
                    url: new node_url.URL(next.reference, response.url),
                };
            }
            return false;
        },
...
const cloneInternals = (internals) => {
    ...
    const result = {
        ...
        searchParams: internals.searchParams ? new node_url.URLSearchParams(internals.searchParams) : undefined,
...
class Options {
    constructor(input, options, defaults) {
        ...
        dist.exports.assert.any([is.string, is.urlInstance, is.object, is.undefined], input);
        dist.exports.assert.any([is.object, is.undefined], options);
        dist.exports.assert.any([is.object, is.undefined], defaults);
    ...
    */
    ...
    set request(value) {
        dist.exports.assert.any([is.function_, is.undefined], value);
    ...
    */
    ...
    set agent(value) {
        dist.exports.assert.plainObject(value);
        // eslint-disable-next-line guard-for-in
        for (const key in value) {
            if (!(key in this._internals.agent)) {
                throw new TypeError(`Unexpected agent option: ${key}`);
            }
            dist.exports.assert.any([is.object, is.undefined], value[key]);
        }
        if (this._merging) {
    ...
    */
    ...
    set decompress(value) {
        dist.exports.assert.boolean(value);
    ...
    */
    ...
    set timeout(value) {
        ...
        for (const key in value) {
            ...
            dist.exports.assert.any([is.number, is.undefined], value[key]);
        }
        if (this._merging) {
    ...
    */
    ...
    set prefixUrl(value) {
        dist.exports.assert.any([is.string, is.urlInstance], value);
        if (value === '') {
    ...
    */
    ...
    set body(value) {
        dist.exports.assert.any([is.string, is.buffer, is.nodeStream, is.generator, is.asyncGenerator, isFormDataLike, is.undefined], value);
        if (is.nodeStream(value)) {
            dist.exports.assert.truthy(value.readable);
        }
        if (value !== undefined) {
            dist.exports.assert.undefined(this._internals.form);
            dist.exports.assert.undefined(this._internals.json);
        }
    ...
    */
    ...
    set form(value) {
        dist.exports.assert.any([is.plainObject, is.undefined], value);
        if (value !== undefined) {
            dist.exports.assert.undefined(this._internals.body);
            dist.exports.assert.undefined(this._internals.json);
        }
    ...
    */
    ...
    set json(value) {
        dist.exports.assert.any([is.object, is.undefined], value);
        if (value !== undefined) {
            dist.exports.assert.undefined(this._internals.body);
            dist.exports.assert.undefined(this._internals.form);
        }
    ...
    */
    ...
    set url(value) {
        dist.exports.assert.any([is.string, is.urlInstance, is.undefined], value);
        if (value === undefined) {
        ...
        const url = new node_url.URL(urlString);
    ...
    */
    ...
    set cookieJar(value) {
        ...
        dist.exports.assert.function_(setCookie);
        dist.exports.assert.function_(getCookieString);
    ...
    */
    get searchParams() {
        ...
        if (this._internals.searchParams === undefined) {
            this._internals.searchParams = new node_url.URLSearchParams();
        }
        return this._internals.searchParams;
    }
    set searchParams(value) {
        dist.exports.assert.any([is.string, is.object, is.undefined], value);
        ...
        let updated;
        if (is.string(value)) {
            updated = new node_url.URLSearchParams(value);
        }
        else if (value instanceof node_url.URLSearchParams) {
            updated = value;
        }
        else {
            validateSearchParameters(value);
            updated = new node_url.URLSearchParams();
            // eslint-disable-next-line guard-for-in
            for (const key in value) {
    ...
    */
    ...
    set dnsCache(value) {
        dist.exports.assert.any([is.object, is.boolean, is.undefined], value);
        if (value === true) {
    ...
    */
    ...
    set context(value) {
        dist.exports.assert.object(value);
        if (this._merging) {
    ...
    */
    ...
    set hooks(value) {
        ...
        for (const knownHookEvent in value) {
            ...
            dist.exports.assert.any([is.array, is.undefined], hooks);
            if (hooks) {
                for (const hook of hooks) {
                    dist.exports.assert.function_(hook);
                }
            }
            if (this._merging) {
                if (hooks) {
    ...
    */
    ...
    set maxRedirects(value) {
        dist.exports.assert.number(value);
    ...
    */
    ...
    set cache(value) {
        dist.exports.assert.any([is.object, is.string, is.boolean, is.undefined], value);
        if (value === true) {
    ...
    */
    ...
    set username(value) {
        dist.exports.assert.string(value);
        const url = this._internals.url;
    ...
    */
    ...
    set parseJson(value) {
        dist.exports.assert.function_(value);
    ...
    */
    ...
    set retry(value) {
        dist.exports.assert.plainObject(value);
        dist.exports.assert.any([is.function_, is.undefined], value.calculateDelay);
        dist.exports.assert.any([is.number, is.undefined], value.maxRetryAfter);
        dist.exports.assert.any([is.number, is.undefined], value.limit);
        dist.exports.assert.any([is.array, is.undefined], value.methods);
        dist.exports.assert.any([is.array, is.undefined], value.statusCodes);
        dist.exports.assert.any([is.array, is.undefined], value.errorCodes);
        dist.exports.assert.any([is.number, is.undefined], value.noise);
    ...
    */
    ...
    set localAddress(value) {
        dist.exports.assert.any([is.string, is.undefined], value);
    ...
    */
    ...
    set cacheOptions(value) {
        dist.exports.assert.plainObject(value);
        dist.exports.assert.any([is.boolean, is.undefined], value.shared);
        dist.exports.assert.any([is.number, is.undefined], value.cacheHeuristic);
        dist.exports.assert.any([is.number, is.undefined], value.immutableMinTimeToLive);
        dist.exports.assert.any([is.boolean, is.undefined], value.ignoreCargoCult);
        for (const key in value) {
    ...
    */
    ...
    set https(value) {
        dist.exports.assert.plainObject(value);
        dist.exports.assert.any([is.boolean, is.undefined], value.rejectUnauthorized);
        dist.exports.assert.any([is.function_, is.undefined], value.checkServerIdentity);
        dist.exports.assert.any([is.string, is.object, is.array, is.undefined], value.certificateAuthority);
        dist.exports.assert.any([is.string, is.object, is.array, is.undefined], value.key);
        dist.exports.assert.any([is.string, is.object, is.array, is.undefined], value.certificate);
        dist.exports.assert.any([is.string, is.undefined], value.passphrase);
        dist.exports.assert.any([is.string, is.buffer, is.array, is.undefined], value.pfx);
        dist.exports.assert.any([is.array, is.undefined], value.alpnProtocols);
        dist.exports.assert.any([is.string, is.undefined], value.ciphers);
        dist.exports.assert.any([is.string, is.buffer, is.undefined], value.dhparam);
        dist.exports.assert.any([is.string, is.undefined], value.signatureAlgorithms);
        dist.exports.assert.any([is.string, is.undefined], value.minVersion);
        dist.exports.assert.any([is.string, is.undefined], value.maxVersion);
        dist.exports.assert.any([is.boolean, is.undefined], value.honorCipherOrder);
        dist.exports.assert.any([is.number, is.undefined], value.tlsSessionLifetime);
        dist.exports.assert.any([is.string, is.undefined], value.ecdhCurve);
        dist.exports.assert.any([is.string, is.buffer, is.array, is.undefined], value.certificateRevocationLists);
        for (const key in value) {
    ...
    */
    ...
    set maxHeaderSize(value) {
        dist.exports.assert.any([is.number, is.undefined], value);
...
const noop = () => { };
class Request extends node_stream.Duplex {
    ...
    pipe(destination, options) {
        if (destination instanceof http$4.ServerResponse) {
    ...
    async _finalizeBody() {
        ...
        if (isForm || isJSON || isBody) {
            ...
            if (isBody) {
                ...
                options.body = (new node_url.URLSearchParams(form)).toString();
            }
            else {
                if (noContentType) {
    ...
    async _onResponseBase(response) {
        ...
        if (options.followRedirect && response.headers.location && redirectCodes.has(statusCode)) {
            ...
            try {
                ...
                const redirectUrl = new node_url.URL(redirectBuffer, url);
    ...
    _prepareCache(cache) {
        if (!cacheableStore.has(cache)) {
            cacheableStore.set(cache, new CacheableRequest$1(((requestOptions, handler) => {
    ...
    async _makeRequest() {
        ...
        try {
            ...
            if (error instanceof CacheableRequest$1.CacheError) {
...
const create = (defaults) => {
    ...
    const paginateEach = (async function* (url, options) {
        ...
        dist.exports.assert.function_(pagination.transform);
        dist.exports.assert.function_(pagination.shouldContinue);
        dist.exports.assert.function_(pagination.filter);
        dist.exports.assert.function_(pagination.paginate);
        dist.exports.assert.number(pagination.countLimit);
        dist.exports.assert.number(pagination.requestLimit);
        dist.exports.assert.number(pagination.backoff);
        const allItems = [];
        ...
        while (numberOfRequests < pagination.requestLimit) {
            ...
            const currentItems = [];
            dist.exports.assert.array(parsed);
            ...
            if (optionsToMerge === response.request.options) {
                ...
                dist.exports.assert.any([is.urlInstance, is.undefined], optionsToMerge.url);
...
var parseUrl = require$$0__default$3["default"].parse;
...
const base64ToUrlSafe = (jsonFlags) => {
  return jsonFlags.replace(/\//g, '_').replace(/\+/g, '-')
};

const urlsafeBase64Encode = (jsonFlags) => {
  return base64ToUrlSafe(Buffer.from(jsonFlags).toString('base64'))
};

const hmacSha1 = (str, secretKey) => {
...
async function uploadFile(filepath, filename, onProgress) {
  ...
  try {
    ...
    .on('uploadProgress', progress => onProgress(progress))
    .json();
...
function index(bank) {
  bank.on('upload', (files) => {
    ...
    files.forEach(file => {
      ...
      memory.push(fileUpload);
      uploadFile(file.path, file.name, (progress) => {
        fileUpload.total = progress.total;
        fileUpload.loaded = progress.transferred;
        fileUpload.percent = progress.percent;
        if (fileUpload.percent === 1) {
          fileUpload.percent = 0.999;
        ...
        if (data.success)  {
          ...
          fileUpload.key = data.data.key;
          fileUpload.w = data.data.w;
          fileUpload.h = data.data.h;
          fileUpload.hash = data.data.hash;
          fileUpload.link = data.data.link;
        } else {
          fileUpload.fail = true;
        }
        bank.emit('progress', memory);
      });
    });
